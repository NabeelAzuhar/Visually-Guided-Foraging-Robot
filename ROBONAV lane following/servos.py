...
#    # Check camera rotation (rotate from -30 to 30 degrees and back)
...
#    servo.set_angle(0)
#    servo.set_differential_drive(0.12, -0.1)
#    time.sleep_ms(1000)
#    servo.set_differential_drive(0, 0)

#    # Check turning movements
    servo.set_speed(0.2, -0.2)  # Turn right
    time.sleep_ms(1000)
    servo.set_speed(0, 0)
    time.sleep_ms(1000)
    servo.set_speed(-0.2, 0.2)  # Turn left
    time.sleep_ms(1000)
    servo.set_speed(0, 0)
    time.sleep_ms(1000)
